                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $c-> id }}</td>
                                <td>{{ $c-> name }}</td>
                                <td>{{ $c-> status == '1' ? 'Hidden':'visiable' }}</td>
                                <td>
                                    <a href="{{ url('admin/category/'.$c->id.'/edit') }}" class="btn btn-success">Edit</a>
                                    <a href="#" wire:click="deleteCategory({{ $c->id }})" data-bs-toggle="modal" data-bs-target="#deleteModal" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
