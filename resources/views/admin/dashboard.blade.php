    ...
    <div class="row p-2">
      <div class="col-md-3">
        <div class="card card-body bg-primary text-white mb-3">
          ...
          <h1>{{$totalAllUsers}}</h1>
          <a href="{{url('admin/products')}}" class="text-white"></a>
        </div>
      </div>
      <div class="col-md-3">
        <div class="card card-body bg-success text-white mb-3">
          ...
          <h1>{{$totalUser}}</h1>
          <a href="{{url('admin/category')}}" class="text-white"></a>
        </div>  
      </div>
      <div class="col-md-3">
        <div class="card card-body bg-danger text-white mb-3">
          ...
          <h1>{{$totalAdmin}}</h1>
          <a href="{{url('admin/brands')}}" class="text-white"></a>
        </div>
      </div>
    </div>
